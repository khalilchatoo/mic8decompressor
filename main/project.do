...
mem save -o simulation_RAM0.mem -f mti -data decimal -addr decimal -wordsperline 8 /tb_project_v2/uut/M2_unit/dual_port_RAM_inst0/altsyncram_component/mem_data
mem save -o simulation_RAM1.mem -f mti -data decimal -addr decimal -wordsperline 8 /tb_project_v2/uut/M2_unit/dual_port_RAM_inst1/altsyncram_component/mem_data
mem save -o simulation_RAM2.mem -f mti -data hex -addr decimal -wordsperline 8 /tb_project_v2/uut/M2_unit/dual_port_RAM_inst2/altsyncram_component/mem_data
